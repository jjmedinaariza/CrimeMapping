---
title: "WEEK 8: AN INTRODUCTION TO REGRESSION"
...
- [Section 8.2: Motivating regression](#motivating-regression)
- [Section 8.3: Fitting a simple regression model](#fitting-a-simple-regression-model)
- [Section 8.4: Residuals revisited: R square](#residuals-revisited-r-square)
- [Section 8.5: Inference with regression](#inference-with-regression)
- [Section 8.6: Fitting regression with categorical predictors](#fitting-regression-with-categorical-predictors)
- [Section 8.7: Motivating multiple regression](#motivating-multiple-regression)
- [Section 8.8: Fitting and interpreting a multiple regression model](#fittin-and-interpreting-a-multiple-regresssion-model)
- [Section 8.9: Presenting your regression results](#presenting-your-regression-results)
- [Section 8.10: Rescaling input variables to assist interpretation](#rescaling-input-variables-to-assist-interpretation)
- [Section 8.11: Testing conditional hypothesis: interactions](#testing-conditional-hypothesis-interactions)
- [Section 8.12: Model building and variable selection](#model-building-and-variable-selection)
- [Section 8.13: Regression assumptions](#regression-assumptions)
...
```{r, echo = FALSE}
ggplot() +
  geom_point(data = ncovr, aes(x = RD90, y = HR90),
             alpha = .2, color ="orange") +
  geom_smooth(data = ncovr, aes(x = RD90, y = HR90),
              method = "lm", se = FALSE, color = "red", size = 1) +
  geom_line(data=ncovr, aes(x = round(RD90/0.1)*0.1, y = HR90), 
          stat='summary',
          fun.y=mean,
          color="blue",
          size=1) +
