...
![figure_projection_families](https://raw.githubusercontent.com/maczokni/2018_labs/master/img/projection_families.png)
...
##A first look at ggmap and basemaps
...
We are going to leave here for now. But if you want to understand better ggmap you may want to read [this article](http://stat405.had.co.nz/ggmap.pdf) by its developers. If you are not familiar with ggplot2 you may also want to have a look at [this tutorial](https://rawgit.com/jjmedinaariza/LAWS70821/master/Week_2_Graphics.html) that we wrote.

**HOMEWORK 1:**

Think about this visualisation. 
1. How yould you characterise the basemap as a vector map or as a raster image?
2. How yould you characterise the layer representing the crimes as a vector map or as a raster image?
...
#Solution
attributes(map1)
ggmap(map1_stamen, base_layer = ggplot(crimes, aes(Longitude, Latitude))) +
  geom_point(aes(colour = Crime.type)) +
...
![](https://raw.githubusercontent.com/maczokni/QSTEP/master/imgs/boundary_selector_1.png) 

Once you have selected these options, click on the "Find" button. That will populate the box below: 

***

![](https://raw.githubusercontent.com/maczokni/QSTEP/master/imgs/boundary_selector_2.png)
...
![](https://raw.githubusercontent.com/maczokni/QSTEP/master/imgs/boundary_selector_3.png) 
...
![](https://raw.githubusercontent.com/maczokni/QSTEP/master/imgs/wait.png)
...
![](https://raw.githubusercontent.com/maczokni/QSTEP/master/imgs/download.png)  
...
![](https://raw.githubusercontent.com/maczokni/QSTEP/master/imgs/save_link_as.png) 
...
![](https://raw.githubusercontent.com/maczokni/QSTEP/master/imgs/folder_contents.png)
...
```{r, echo=FALSE}
#sorry I had to use my own filepath here, I couldn't figure out how to read from dropbox link or github, just change back to your own path when knitting...

shp_name <- "/Users/reka/Dropbox (The University of Manchester)/31152_60142 GIS and Crime Mapping/CrimeMapping/BoundaryData/england_lsoa_2011.shp"
```
...
![](https://raw.githubusercontent.com/maczokni/MSCD/master/imgs/fn2187.png)
...
![](https://raw.githubusercontent.com/maczokni/MSCD/master/imgs/merge_logic_1.png)
...
![](https://raw.githubusercontent.com/maczokni/MSCD/master/imgs/merge_logic_2.png)
